...
CREATE TABLE t1 AS SELECT get_closest(g) FROM points;

SELECT 4890 AS id, ST_AsText(ST_SnapToGrid(ST_Centroid(ST_Collect(get_closest )), 0.0001)) FROM t1 ;
DROP TABLE points;
