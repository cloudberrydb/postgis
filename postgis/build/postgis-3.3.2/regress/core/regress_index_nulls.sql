...
create table indexnulls (g geography, id integer) DISTRIBUTED BY (id);
...
drop table if exists indexnulls;
create table indexnulls (g geometry, id integer) DISTRIBUTED BY (id);
create index nulls_gix on indexnulls using gist (g);
...
create table indexempty (g geography, id integer) DISTRIBUTED BY (id);
...
-- All empty on geometry
drop table if exists indexempty;
create table indexempty (g geometry, id integer) DISTRIBUTED BY (id);
create index empty_gix on indexempty using gist (g);
