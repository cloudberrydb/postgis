...
static int srids[] = {
    ...
    32766,
    900913,
    /* below 6 SRIDs are used by regress tests   *
     *   'rt_gdalwarp.sql' and 'rt_asraster.sql' */
    974269,
    984269,
    992163,
    993309,
...
char * getSRSbySRIDbyRule(int srid, bool short_crs, char *buffer)
{
    ...
    /* XXX: this line to comfort regress tests rt_gdalwarp and rt_asraster */
    if(srid > 900913) srid = srid % 10000;
